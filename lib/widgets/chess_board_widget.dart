                    ...
                    children: [
                      Transform(
                        ...
                        transform: matrix.clone()
                          ..translate(0.0, boardSize * 0.035, 0.0)
                          ..scale(1.025),
                        child: Container(
                          width: boardSize,
                          height: boardSize,
                                                ...
                                                Text(
                                                  ...
                                                  style: TextStyle(
                                                    fontSize: visual
                                                        ...
                                                        : boardSize / 9.2,
                                                    fontWeight: FontWeight.w900,
                                                    color: whitePiece(piece)
                                                        ? const Color(0xFFE9DEC5)
                                                        : const Color(0xFF050505),
                                                    shadows: [
                                                      Shadow(
                                                        color: Colors.black.withValues(alpha: 0.74),
                                                        blurRadius: visual ? 8 : 5,
                                                        offset: const Offset(2, 3),
                                                      ),
                                                      Shadow(
                                                        color: const Color(0xFFB08A2E)
                                                            .withValues(alpha: visual ? 0.5 : 0.25),
                                                        blurRadius: visual ? 12 : 6,
                                                      ),
                                                    ],
                                                  ),
                                                ),
