  ...
  void decrypt() {
    ...
    setState(() {
      if (envelope == null) {
        ...
        envelopeDetails =
            'Route: \${envelope.routeHint}\nTime: \${envelope.timestamp}\nFP: \${envelope.sessionFingerprint}';
    ...
    return _SidePanel(
      ...
      child: Column(
        children: [
          ...
          if (envelopeDetails.isNotEmpty)
            _Output(text: envelopeDetails),
